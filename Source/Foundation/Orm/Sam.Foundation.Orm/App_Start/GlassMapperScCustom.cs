...
namespace Sam.Foundation.Orm.App_Start
{
    public static class GlassMapperScCustom
    {
        ...
        public static void AddMaps(IConfigFactory<IGlassMap> mapsConfigFactory)
        {
            ...
            foreach (string dll in Directory.GetFiles(binPath, "Sam*.dll", SearchOption.AllDirectories))
            {
                try
                {
                ...
                catch (FileLoadException loadEx) { } // The Assembly has already been loaded. 
                catch (BadImageFormatException imgEx) { } // If exception is thrown, the file is not an assembly. 
            }
        }
    }
}
